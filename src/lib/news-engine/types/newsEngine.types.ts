...
export type NewsSourceId = 'gnews' | 'newsdata' | 'newsapi' | 'rss_et' | 'rss_mc' | 'finnhub'
...
/**
 * Per-source health row emitted by the orchestrator. Lets the UI
...
export interface IngestionResult {
  ...
  /** ISO timestamp of the newest publishedAt this run emitted (or null). */
  latestNewsPublishedAt?: string | null;
  /** ISO timestamp marking when this pipeline run completed. */
