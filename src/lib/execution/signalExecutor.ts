...
//  postback webhook at /api/kite/postback, which transitions the // @deprecated marker
//  position from PENDING → OPEN and eventually OPEN → CLOSED.
//
//  Fire-and-forget: the listener never awaits the async pipeline
//  inside the bus callback — blocking the bus on a 500ms Kite // @deprecated marker
