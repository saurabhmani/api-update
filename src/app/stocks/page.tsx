...
function StocksPageInner() {
  ...
  // Yahoo-only mode: source is either yahoo or none for the floating badge. // @deprecated marker
  const srcTally = { yahoo: 0, none: 0 }; // @deprecated marker
  for (const e of entries.values()) {
    const s = (e.source === 'yahoo' ? 'yahoo' : 'none') as 'yahoo' | 'none'; // @deprecated marker
    srcTally[s] += 1;
  }
  const floatingSource: 'yahoo' | 'none' = // @deprecated marker
    srcTally.yahoo > 0 ? 'yahoo' : 'none'; // @deprecated marker
