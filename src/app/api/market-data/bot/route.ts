...
//
//  Yahoo-only live-quote polling endpoint for the stock detail bot.
//  Per symbol returns:
//    { symbol, price, change, pChange, close, source, status, lastUpdated }
//
//  Status classification post-Kite-removal:
//    DELAYED  — Yahoo snapshot, market OPEN (15-min delayed)
//    CLOSED   — Yahoo returned yesterday's close, market CLOSED
//    OFFLINE  — Yahoo returned nothing for this symbol
//
...
export type BotSource = 'yahoo' | 'none';
