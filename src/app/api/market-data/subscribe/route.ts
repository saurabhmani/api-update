...
//
//  Pre-Kite-removal this endpoint registered symbols with the Kite
//  WebSocket ticker. The WebSocket path has been removed; live
//  prices now come from Yahoo Finance polled per-request by the
...
//  client-side hook will keep polling Yahoo on its own cadence and
