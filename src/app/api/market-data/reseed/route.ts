...
//
//  Manual trigger for streamServer.seedKiteMapFromDaily(). Use this
...
//  kiteMap so you can verify a specific symbol's value in the cache.
//
//  Usage:
...
import { seedKiteMapFromDaily } from '@/lib/ws/streamServer';
...
export async function GET(req: NextRequest) {
  ...
  // 1. Run the seed — overwrites stale (>90s old) entries in kiteMap
